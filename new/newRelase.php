<?php
    ...
    if (!$db) {
        ...
        $sql = "SELECT * from TravelPlan order by TPId DESC"; 
...
<div id="wrapper">
	<div id="container">
		...
		<header id="header">
			...
			<div id="navigation">
				<ul id="nav">
					...
					<li class='selected'><a href="newRelase.php">New Realse</a></li>
		...
		<div class="subheader">
			<div class="left">
				<span class="page-title">NewRelase</span>
				<span class="page-desc">The most fashion travel plan</span>
			</div>
		</div>
		<!--subheader -->
		<div id="content">
		...
		for($a = 0;$a<count($TP_new) && $a<5;$a++){
				echo'<div class="post-item post-blog">
					...
					<div class="post-meta">
						...
						<a class="read-more" href="./browse-detail.php?TPId='.$TP_new[$a]['TPId'].'">Booking</a>
					</div>
				</div>';
		}
		?>
